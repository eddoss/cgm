...
{
    return (value > T(1) ? T(1) : value < T(0) ? T(0) : value) * (newMax - newMin) + newMin;
}
...
{
    return ((value > T(1) ? T(1) : value < T(0) ? T(0) : value) - T(1)) * (newMin - newMax) + newMin;
}
...
{
    return ((value > T(1) ? T(1) : value < T(-1) ? T(-1) : value) - T(-1)) / T(2) * (newMax - newMin) + newMin;
}
