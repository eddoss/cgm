...
#include <CGM/Transformations/2D/Operators.hpp>

#include <CGM/Transformations/2D/Functions/Utils.hpp>
...
#include <CGM/Transformations/2D/Functions/Converters/Axis.hpp>
#include <CGM/Transformations/2D/Functions/Converters/Pivot.hpp>
#include <CGM/Transformations/2D/Functions/IO.hpp>