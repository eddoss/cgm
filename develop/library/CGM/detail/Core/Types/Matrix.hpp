...
#include <CGM/detail/Core/Support/Matrix/Iterators/Row_impl.hpp>
#include <CGM/detail/Core/Support/Matrix/Iterators/Column_impl.hpp>
...
#include <CGM/detail/Core/Types/Matrix_impl.hpp>