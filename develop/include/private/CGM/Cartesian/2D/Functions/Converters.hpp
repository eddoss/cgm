...
{
#ifdef CGM_USE_COLUMN_MAJOR_VECTOR_REPRESENTATION
    return _internal_multiply_matrix3x3_on_vector2<Representation>(_internal_fast_inverse_matrix3x3(localSpace), vector);
#else
    return _internal_multiply_vector2_on_matrix3x3<Representation>(vector, _internal_fast_inverse_matrix3x3(localSpace));
#endif
}
