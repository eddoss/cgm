...
template<size_t D, typename T>
constexpr FORCEINLINE Vector <D, T, std::enable_if_t<(D == 2)>>&
...
template<size_t D, typename T>
constexpr FORCEINLINE typename Vector <D, T, std::enable_if_t<(D == 2)>>::pointer
...
template<size_t D, typename T>
constexpr FORCEINLINE typename Vector <D, T, std::enable_if_t<(D == 2)>>::const_pointer
...
template<size_t D, typename T>
constexpr FORCEINLINE Vector <D, T, std::enable_if_t<(D == 3)>>&
...
template<size_t D, typename T>
constexpr FORCEINLINE typename Vector <D, T, std::enable_if_t<(D == 3)>>::pointer
...
template<size_t D, typename T>
constexpr FORCEINLINE typename Vector <D, T, std::enable_if_t<(D == 3)>>::const_pointer
...
template<size_t D, typename T>
constexpr FORCEINLINE Vector <D, T, std::enable_if_t<(D == 4)>>&
...
template<size_t D, typename T>
constexpr FORCEINLINE typename Vector <D, T, std::enable_if_t<(D == 4)>>::pointer
...
template<size_t D, typename T>
constexpr FORCEINLINE typename Vector <D, T, std::enable_if_t<(D == 4)>>::const_pointer
...
template<size_t D, typename T>
constexpr FORCEINLINE typename Vector <D, T, std::enable_if_t<(D > 4)>>::reference
...
template<size_t D, typename T>
constexpr FORCEINLINE typename Vector <D, T, std::enable_if_t<(D > 4)>>::const_reference
...
template<size_t D, typename T>
constexpr FORCEINLINE typename Vector <D, T, std::enable_if_t<(D > 4)>>::iterator
...
template<size_t D, typename T>
constexpr FORCEINLINE typename Vector <D, T, std::enable_if_t<(D > 4)>>::const_iterator
...
template<size_t D, typename T>
constexpr FORCEINLINE typename Vector <D, T, std::enable_if_t<(D > 4)>>::reverse_iterator
...
template<size_t D, typename T>
constexpr FORCEINLINE typename Vector <D, T, std::enable_if_t<(D > 4)>>::const_reverse_iterator
