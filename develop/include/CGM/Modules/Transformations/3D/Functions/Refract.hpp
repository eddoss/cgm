...
template<typename T>
constexpr void
refract(Vector<3,T>& vector, const Vector<3,T>& planeNormal);
...
template<typename T>
constexpr void
refract(Vector<3,T>& vector, const Vector<3,T>& planeNormal, const Vector<3,T>& planeCenter);
...
template<typename T>
constexpr void
refract(Matrix<3,3,T>& matrix, const Vector<3,T>& planeNormal);
...
template<typename T>
constexpr void
refract(Matrix<4,4,T>& matrix, const Vector<3,T>& planeNormal);
...
template<typename T>
constexpr void
refract(Matrix<4,4,T>& matrix, const Vector<3,T>& planeNormal, const Vector<3,T>& planeCenter);
...
template<typename T>
constexpr void
refract(Pivot<T>& pivot, Vector<3,T>& planeNormal);
...
template<typename T>
constexpr void
refract(Pivot<T>& pivot, Vector<3,T>& planeNormal, Vector<3,T>& planeCenter);
...
template<typename T>
constexpr void
refract(AxesTuple<T>& axes, const Vector<3,T>& planeNormal);
...
template<typename T>
constexpr void
refract(SpaceTuple<T>& space, const Vector<3,T>& planeNormal);
...
template<typename T>
constexpr void
refract(SpaceTuple<T>& space, const Vector<3,T>& planeNormal, const Vector<3,T>& planeCenter);
...
constexpr void
refract(Basis<Base,T>& basis, const Vector<3,T>& planeNormal);
...
template<EBasisBase Base, typename T>
constexpr void
refract(Basis<Base,T>& basis, const Vector<3,T>& planeNormal, const Vector<3,T>& planeCenter);
