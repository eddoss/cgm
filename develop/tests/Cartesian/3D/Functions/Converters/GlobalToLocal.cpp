...
TEST(Cartesian_3D_Functions_Converters, GlobalToLocal_Mat3)
{
    ...
    auto result = CGM_XYZ::globalToLocal(GLOBAL_COORD, A_MAT3);
...
TEST(Cartesian_3D_Functions_Converters, GlobalToLocal_Mat3WithPos)
{
    ...
    {
        auto result = CGM_XYZ::globalToLocal<CGM_POINT>(GLOBAL_COORD, A_MAT3, A_P);
        ASSERT_TRUE(CGM::eq(result, GLOBAL_COORD_CONVERTED_TO_LOCAL_A__SPACE_POINT, 0.0001));
    }

    {
        auto result = CGM_XYZ::globalToLocal<CGM_DIRECTION>(GLOBAL_COORD, A_MAT3, A_P);
        ASSERT_TRUE(CGM::eq(result, GLOBAL_COORD_CONVERTED_TO_LOCAL_A__ORIENT_DIR, 0.0001));
    }
}
...
TEST(Cartesian_3D_Functions_Converters, GlobalToLocal_Mat4)
{
    ...
    {
        auto result = CGM_XYZ::globalToLocal<CGM_POINT>(GLOBAL_COORD, A_MAT4);
        ASSERT_TRUE(CGM::eq(result, GLOBAL_COORD_CONVERTED_TO_LOCAL_A__SPACE_POINT, 0.0001));
    }

    {
        auto result = CGM_XYZ::globalToLocal<CGM_DIRECTION>(GLOBAL_COORD, A_MAT4);
        ASSERT_TRUE(CGM::eq(result, GLOBAL_COORD_CONVERTED_TO_LOCAL_A__ORIENT_DIR, 0.0001));
    }
}
...
TEST(Cartesian_3D_Functions_Converters, GlobalToLocal_Quat)
{
    ...
    auto result = CGM_XYZ::globalToLocal(GLOBAL_COORD, A_QUAT);
    ASSERT_TRUE(CGM::eq(result, GLOBAL_COORD_CONVERTED_TO_LOCAL_A__ORIENT_DIR, 0.0001));
}
...
TEST(Cartesian_3D_Functions_Converters, GlobalToLocal_QuatWithPos)
{
    ...
    {
        auto result = CGM_XYZ::globalToLocal<CGM_POINT>(GLOBAL_COORD, A_QUAT, A_P);
        ASSERT_TRUE(CGM::eq(result, GLOBAL_COORD_CONVERTED_TO_LOCAL_A__SPACE_POINT, 0.0001));
    }

    {
        auto result = CGM_XYZ::globalToLocal<CGM_DIRECTION>(GLOBAL_COORD, A_QUAT, A_P);
        ASSERT_TRUE(CGM::eq(result, GLOBAL_COORD_CONVERTED_TO_LOCAL_A__ORIENT_DIR, 0.0001));
    }
}