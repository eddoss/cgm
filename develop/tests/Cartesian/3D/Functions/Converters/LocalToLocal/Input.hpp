...
static const auto A_GLOBAL_COORD = CGM::Vector<3,double>{ 1.00000, 0.00000, 0.00000 };
...
static const auto A_GLOBAL_COORD_CONVERTED_TO_LOCAL__ORIENT_DIR = CGM::Vector<3,double>{ 0.93358, -0.358368, 0.0 };
static const auto A_GLOBAL_COORD_CONVERTED_TO_LOCAL__SPACE_POINT = CGM::Vector<3,double>{ 0.768549, -0.509247, 0.0 };
