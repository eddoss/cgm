...
{
    {
        ...
        ASSERT_TRUE(CGM::equal(result_p, L2LBASIS_B_COORD_PT_DIR, 0.0001));
        ASSERT_TRUE(CGM::equal(result_d, L2LBASIS_B_COORD_DIR_DIR, 0.0001));
    }
...
{
    {
        ...
        ASSERT_TRUE(CGM::equal(result_p, L2LBASIS_B_COORD_PT_PT, 0.0001));
        ASSERT_TRUE(CGM::equal(result_d, L2LBASIS_B_COORD_DIR_DIR, 0.0001));
    }
