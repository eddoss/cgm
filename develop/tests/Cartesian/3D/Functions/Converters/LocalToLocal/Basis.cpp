...
TEST(Cartesian_3D_Functions_Converters, LocalToLocal_QuatWithPos_Mat3)
{
    ...
    {
        auto reslt = MATH3D_XYZ_NAMESPACE::localToLocal<POINT>(coord, basisA, PA, basisB);
        auto expec = MATH3D_XYZ_NAMESPACE::localToGlobal<POINT>(coord, basisA, PA);
        expec = MATH3D_XYZ_NAMESPACE::globalToLocal(expec, basisB);
        ASSERT_TRUE(MATH3D_NAMESPACE::equal(expec, reslt, 0.0001));
    }

    {
        auto reslt = MATH3D_XYZ_NAMESPACE::localToLocal<DIRECTION>(coord, basisA, PA, basisB);
        auto expec = MATH3D_XYZ_NAMESPACE::localToGlobal<DIRECTION>(coord, basisA, PA);
        expec = MATH3D_XYZ_NAMESPACE::globalToLocal(expec, basisB);
        ASSERT_TRUE(MATH3D_NAMESPACE::equal(expec, reslt, 0.0001));
    }
}
...
TEST(Cartesian_3D_Functions_Converters, LocalToLocal_QuatWithPos_Mat3WithPos)
{
    ...
    {
        auto reslt = MATH3D_XYZ_NAMESPACE::localToLocal<POINT>(coord, basisA, PA, basisB, PB);
        auto expec = MATH3D_XYZ_NAMESPACE::localToGlobal<POINT>(coord, basisA, PA);
    ...
    {
        auto reslt = MATH3D_XYZ_NAMESPACE::localToLocal<DIRECTION>(coord, basisA, PA, basisB, PB);
        auto expec = MATH3D_XYZ_NAMESPACE::localToGlobal<DIRECTION>(coord, basisA, PA);
