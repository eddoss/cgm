...
namespace cgm_xyz_matrix3x3_converters_tests_data
{
...
static const auto EXPECT_MAT4_BY_MAT3_TO_WORLD = CGM::Vector<3,double>{ +1.00000, +0.00000, +0.00000 };
static const auto EXPECT_MAT4_BY_MAT4_TO_WORLD = CGM::Vector<3,double>{ +1.00000, +0.00000, +0.00000 };
