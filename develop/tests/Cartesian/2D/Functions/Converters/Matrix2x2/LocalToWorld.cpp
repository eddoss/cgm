...
#include <CGM/detail/Modules/Cartesian/2D/Functions/Converters/Matrix2x2.hpp>
#include "../Input.hpp"
...
TEST(Cartesian_2D_Functions_Matrix2x2_Converters, LocalToWorld_Mat2)
{
    ...
    auto result = CGM_XY::converted<CGM_WORLD>(MAT2, A_MAT2);
...
TEST(Cartesian_2D_Functions_Matrix2x2_Converters, LocalToWorld_Mat3)
{
    ...
    auto result = CGM_XY::converted<CGM_WORLD>(MAT2, A_MAT3);
    ASSERT_TRUE(CGM::eq(result, EXPECT_MAT2_TO_WORLD, 0.0001));
}