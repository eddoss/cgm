...
TEST(Cartesian_2D_Functions_Converters, LocalToLocal_Mat2WithPos_Mat2)
{
    ...
    {
        auto result = CGM_XY::localToLocal<CGM_POINT>(A_LOCAL_COORD, A_MAT2, A_P, B_MAT2);
        ASSERT_TRUE(CGM::eq(result, A_LOCAL_COORD_CONVERTED_TO_LOCAL_B__SPACE_2_ORIENT, 0.0001));
    }

    {
        auto result = CGM_XY::localToLocal<CGM_DIRECTION>(A_LOCAL_COORD, A_MAT2, A_P, B_MAT2);
...
TEST(Cartesian_2D_Functions_Converters, LocalToLocal_Mat2WithPos_Mat2WithPos)
{
    ...
    {
        auto result = CGM_XY::localToLocal<CGM_POINT>(A_LOCAL_COORD, A_MAT2, A_P, B_MAT2, B_P);
        ASSERT_TRUE(CGM::eq(result, A_LOCAL_COORD_CONVERTED_TO_LOCAL_B__SPACE_2_SPACE, 0.0001));
    }

    {
        auto result = CGM_XY::localToLocal<CGM_DIRECTION>(A_LOCAL_COORD, A_MAT2, A_P, B_MAT2, B_P);
        ASSERT_TRUE(CGM::eq(result, A_LOCAL_COORD_CONVERTED_TO_LOCAL_B__ORIENT_2_ORIENT, 0.0001));
    }
}
...
TEST(Cartesian_2D_Functions_Converters, LocalToLocal_Mat2WithPos_Mat3)
{
    ...
    {
        auto result = CGM_XY::localToLocal<CGM_POINT>(A_LOCAL_COORD, A_MAT2, A_P, B_MAT3);
        ASSERT_TRUE(CGM::eq(result, A_LOCAL_COORD_CONVERTED_TO_LOCAL_B__SPACE_2_SPACE, 0.0001));
    }

    {
        auto result = CGM_XY::localToLocal<CGM_DIRECTION>(A_LOCAL_COORD, A_MAT2, A_P, B_MAT3);
        ASSERT_TRUE(CGM::eq(result, A_LOCAL_COORD_CONVERTED_TO_LOCAL_B__ORIENT_2_ORIENT, 0.0001));
    }
}