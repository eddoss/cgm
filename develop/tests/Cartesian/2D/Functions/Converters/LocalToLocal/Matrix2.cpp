...
TEST(Cartesian_2D_Functions_Converters, LocalToLocal_Mat2_Mat2)
{
    ...
    ASSERT_TRUE(CGM::eq(result, L2L2DMAT2_B_COORD_DIR, 0.0001));
}
...
{
    {
        ...
        ASSERT_TRUE(CGM::eq(result, L2L2DMAT2_B_COORD_PT, 0.0001));
    }
...
{
    {
        ...
        ASSERT_TRUE(CGM::eq(result_p, L2L2DMAT2_B_COORD_PT, 0.0001));
        ASSERT_TRUE(CGM::eq(result_d, L2L2DMAT2_B_COORD_DIR, 0.0001));
    }
