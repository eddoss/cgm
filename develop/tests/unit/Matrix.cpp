...
TEST(Matrix, ColumnIterators_BinaryPlus)
{
...
TEST(Matrix, ColumnIterators_BinaryMinus)
{
    Matrix<3,3,int> input
    {
        1, 2, 3,
...
TEST(Matrix, ColumnIterators_PostIncrement)
{
    Matrix<3,3,int> input
    {
        1, 2, 3,
...
TEST(Matrix, ColumnIterators_PreIncrement)
{
    Matrix<3,3,int> input
    {
        1, 2, 3,
...
TEST(Matrix, ColumnIterators_PostDecrement)
{
    Matrix<3,3,int> input
    {
        1, 2, 3,
...
TEST(Matrix, ColumnIterators_PreDecrement)
{
    Matrix<3,3,int> input
    {
        1, 2, 3,
